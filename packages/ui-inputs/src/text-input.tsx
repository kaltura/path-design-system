...
export function CustomInput(props: any) {
    ...
    const [isControlled] = useState(value === '' || !!value);
...
export function View(props: any) {
    // const { ignoreUserRequests } = props;

    // const handleOnClear = () => {
    //     if (ignoreUserRequests) {
    //         return;
    //     }
    //
    //     setValue('');
    ...
    //return <CustomInput value={value} onClear={handleOnClear} />
    return <CustomInput defaultValue={'123'} inputRef={ref => {}/>
}
