    ...
    <Story name="default">
        <div className="row">
                ...
                <div className="col">
                    ...
                    <Button isProcessing={boolean("Processing", false)} label={text("Label", "Label")} onClick={action('clicked')}/>
                    <Button isProcessing={boolean("Processing", false)} disabled={true} label={text("Label", "Label")} onClick={action('clicked')}/>
                    <Button isProcessing={boolean("Processing", false)} isActive={true} label={text("Label", "Label")} onClick={action('clicked')}/>
                </div>
                <div className="spacer"></div>
                <div className="col">
                    <span className="label">Icon + Label</span>
                    <Button isProcessing={boolean("Processing", false)} label={text("Label", "Label")} icon={<Plus24Icon/>} onClick={action('clicked')}/>
...
<Preview>
    <Story name="borderless">
        <div className="row">
                ...
                <div className="col">
                    <span className="label">Label</span>
                    <Button isProcessing={boolean("Processing", false)} borderless={true} label={text("Label", "Label")} onClick={action('clicked')}/>
                ...
                <div className="col">
                    ...
                    <Button borderless={true} disabled={true} label={text("Label", "Label")}
                            isProcessing={true} onClick={action('clicked')}/>
